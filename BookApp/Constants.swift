...
class Constants {
    ...
    /// API Keys
    static let revenueCat = "appl_XpJhzYJhKkLkJltzxQHHdRtWNuk" /// IMPORTANT: This API key is set to BookApp RevenueCat project. Change it to yours...
