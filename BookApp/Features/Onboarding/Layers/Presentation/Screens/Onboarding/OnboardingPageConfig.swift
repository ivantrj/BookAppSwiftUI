...
extension OnboardingPageConfig {
    ...
    static var page3: Self {
        .init(
            ...
            description: "BookApp is built on top of the clean architecture principles. It follows the best practices of software engineering and it's easily testable and scalable.",
